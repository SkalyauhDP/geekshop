...
urlpatterns = [
    ...
    #path('users/update/<int:pk>', adminapp.UserCreateView.as_view(), name='user_update'),
    ...
    #path('categories/read/', adminapp.CategoriesDetailView.as_view(), name='categories'),
    ...
    # path('products/read/<int:pk>', adminapp.product_read, name='product'),
